...
namespace DocuSign.CodeExamples.Controllers
{
    ...
    public class SetTemplateTabValues : EgController
    {
        ...
        public SetTemplateTabValues(DSConfiguration config, IRequestItemsService requestItemsService)
        ...
        public IActionResult Create(string signerEmail, string signerName, string ccEmail, string ccName)
        {
            ...
            (string envelopeId, string redirectUrl) = global::eSignature.Examples.SetTemplateTabValues.CreateEnvelopeFromTempalteAndUpdateTabValues(signerEmail, signerName,
