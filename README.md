...
1. **Request a signature by SMS delivery**
   ...
   This code example demonstrates how to send a signature request via an SMS message using the [Create Envelope](https://developers.docusign.com/esign-rest-api/reference/Envelopes/Envelopes/create) method.
