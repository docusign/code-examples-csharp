    ...
    public class CreateUser: EgController
    {
        ...
        public ActionResult Create(string email, string firstName, string lastName, string userName, string permissionProfileId, string groupId)
        {
            ...
            try
            {
                ...
                var user = Examples.CreateUser.CreateNewUser(accessToken, basePath, Guid.Parse(accountId), 
                    organizationId, firstName, lastName, userName, email, long.Parse(permissionProfileId), long.Parse(groupId));
