// <copyright file="AccountRoleSettingsModel.cs" company="DocuSign">
...
namespace DocuSign.CodeExamples.Models
{
    ...
    public class AccountRoleSettingsModel
    {
        ...
        public AccountRoleSettingsModel(AccountRoleSettings accountRoleSettings)
        {
            ...
            this.AllowApiAccess = bool.TryParse(accountRoleSettings.AllowApiAccess, out bool allowApiAccess) && allowApiAccess;
            this.AllowApiAccessToAccount = bool.TryParse(accountRoleSettings.AllowApiAccessToAccount, out bool allowApiAccessToAccount) && allowApiAccessToAccount;
        }
