    ...
    public class ImportUser : EgController
    {
        ...
        public ActionResult Create()
        {
            ...
            try
            {
                ...
                OrganizationImportResponse organizationImportResponse = Examples.ImportUser.CreateBulkImportRequest(
        ...
        public ActionResult CheckStatus(string id)
        {
            try
            {
                ...
                var basePath = RequestItemsService.Session.AdminApiBasePath;
                var organizationId = RequestItemsService.OrganizationId;
                OrganizationImportResponse organizationImportResponse = Examples.ImportUser.CheckkStatus(accessToken, basePath, organizationId, Guid.Parse(id));
