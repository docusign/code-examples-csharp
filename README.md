...
For information about the scopes used for obtaining authorization to use the Admin API, see the [scopes](https://developers.docusign.com/docs/admin-api/admin101/auth/) section.
