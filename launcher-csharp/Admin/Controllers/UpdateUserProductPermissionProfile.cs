...
namespace DocuSign.CodeExamples.Admin.Controllers
{
    ...
    public class UpdateUserProductPermissionProfile : EgController
    {
        ...
        public UpdateUserProductPermissionProfile(
        ...
        public ActionResult UpdateUsersProductPermissionProfile(string productId, string permissionProfileId)
        {
            try
            {
                ...
                UserProductPermissionProfilesResponse response = UpdateUserProductPermissionProfileByEmail.UpdateUsersProductPermissionProfile(
                    basePath, 
                    accessToken, 
                    organizationId, 
                    accountId, 
